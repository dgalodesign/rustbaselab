...
import { Inter, JetBrains_Mono, Space_Grotesk as V0_Font_Space_Grotesk, Space_Mono as V0_Font_Space_Mono, Source_Serif_4 as V0_Font_Source_Serif_4 } from 'next/font/google'
