  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-balance">Términos y Condiciones</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">4. Contenido de Terceros</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">5. Publicidad</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">6. Descargo de Responsabilidad</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-foreground">9. Ley Aplicable</h2>
            <p>
