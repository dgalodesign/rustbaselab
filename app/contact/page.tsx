        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="border-2 border-border rounded-lg p-6 bg-card hover:border-primary transition-colors">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold font-display">Email</h2>
              </div>
            ...
            <div className="border-2 border-border rounded-lg p-6 bg-card hover:border-primary transition-colors">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold font-display">Feedback</h2>
              </div>
          ...
          <div className="border-2 border-border rounded-lg p-6 bg-card">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-bold font-display text-foreground mb-2">¿Los diseños están actualizados?</h3>
                <p className="text-muted-foreground">
